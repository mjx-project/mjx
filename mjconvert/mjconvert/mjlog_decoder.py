...
def reproduce_wall_from_mjlog(mjlog_str: str, store_cache=True) -> List[Tuple[List[int], List[int]]]:
    """ SeedをXMLから切り出す
...
def reproduce_wall_from_seed(seed: str, store_cache=True) -> List[Tuple[List[int], List[int]]]:
