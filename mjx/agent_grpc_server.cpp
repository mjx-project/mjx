...
namespace mjx
{
    ...
    void
    AgentGrpcServer::RunServer(std::unique_ptr<Strategy> strategy, const std::string &socket_address) {
        std::unique_ptr<grpc::Service> agent_impl = std::make_unique<AgentGrpcServerImpl>(std::move(strategy));
