...
TEST(open, Chi)
{
    ...
    c = Open(static_cast<std::uint16_t>(49495));  // http://tenhou.net/5/?log=2019101219gm-0009-0000-a1515896
    EXPECT_EQ(c.Type(), OpenType::kChi);
    EXPECT_EQ(c.From(), RelativePos::kLeft);
...
TEST(open, Pon)
{
    ...
    // samples from Tenhou  TODO: add more test cases
    p = Open(static_cast<std::uint16_t>(47723));  // http://tenhou.net/5/?log=2019101219gm-0009-0000-a1515896
    EXPECT_EQ(p.Type(), OpenType::kPon);
...
TEST(open, OpenGenerator)
{
    ...
    EXPECT_TRUE(check(o, {tt::kWD, tt::kWD, tt::kWD}, tt::kWD, RelativePos::kLeft));
    o = Open(51306);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kRD, tt::kRD, tt::kRD}, tt::kRD, RelativePos::kMid));
    o = Open(49495);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kS3, tt::kS4, tt::kS5}, tt::kS3, RelativePos::kLeft));
    o = Open(3146);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kM3, tt::kM3, tt::kM3}, tt::kM3, RelativePos::kMid));
    // EAST 1 1
    o = Open(42058);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kEW, tt::kEW, tt::kEW}, tt::kEW, RelativePos::kMid));
    o = Open(40489);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kS9, tt::kS9, tt::kS9}, tt::kS9, RelativePos::kRight));
    o = Open(34911);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kP5, tt::kP6, tt::kP7}, tt::kP6, RelativePos::kLeft));
    o = Open(27178);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kP9, tt::kP9, tt::kP9}, tt::kP9, RelativePos::kMid));
    o = Open(37063);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kP6, tt::kP7, tt::kP8}, tt::kP6, RelativePos::kLeft));
    // East 1 2
    o = Open(12905);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kM9, tt::kM9, tt::kM9}, tt::kM9, RelativePos::kRight));
    o = Open(51753);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kRD, tt::kRD, tt::kRD}, tt::kRD, RelativePos::kRight));
    o = Open(50679);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kS3, tt::kS4, tt::kS5}, tt::kS4, RelativePos::kLeft));
    o = Open(14679);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kM5, tt::kM6, tt::kM7}, tt::kM7, RelativePos::kLeft));
    // East 1 3
    o = Open(43);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kM1, tt::kM1, tt::kM1}, tt::kM1, RelativePos::kLeft));
    o = Open(7583);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kM3, tt::kM4, tt::kM5}, tt::kM4, RelativePos::kLeft));
    // East 1 4
    o = Open(4649);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kM4, tt::kM4, tt::kM4}, tt::kM4, RelativePos::kRight));
    o = Open(2063);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kM1, tt::kM2, tt::kM3}, tt::kM3, RelativePos::kLeft));
    o = Open(20615);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kM7, tt::kM8, tt::kM9}, tt::kM9, RelativePos::kLeft));
    // East 2 0
    o = Open(42539);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kEW, tt::kEW, tt::kEW}, tt::kEW, RelativePos::kLeft));
    // East 2 1
    o = Open(46633);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kNW, tt::kNW, tt::kNW}, tt::kNW, RelativePos::kRight));
    o = Open(41481);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kEW, tt::kEW, tt::kEW}, tt::kEW, RelativePos::kRight));
    o = Open(31241);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kS3, tt::kS3, tt::kS3}, tt::kS3, RelativePos::kRight));
    // East 2 2
    // East 2 3
    o = Open(47690);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kWD, tt::kWD, tt::kWD}, tt::kWD, RelativePos::kMid));
    // East 2 4
    o = Open(48683);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kWD, tt::kWD, tt::kWD}, tt::kWD, RelativePos::kLeft));
    o = Open(39399);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kP6, tt::kP7, tt::kP8}, tt::kP8, RelativePos::kLeft));
    o = Open(52303);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kS4, tt::kS5, tt::kS6}, tt::kS4, RelativePos::kLeft));
    // EAST 3 0
    o = Open(43081);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kSW, tt::kSW, tt::kSW}, tt::kSW, RelativePos::kRight));
    o = Open(42058);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kEW, tt::kEW, tt::kEW}, tt::kEW, RelativePos::kMid));
    // EAST 4 0
    o = Open(60751);
    EXPECT_EQ(o.Type(), OpenType::kChi);
    EXPECT_TRUE(check(o, {tt::kS6, tt::kS7, tt::kS8}, tt::kS8, RelativePos::kLeft));
    o = Open(47625);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kWD, tt::kWD, tt::kWD}, tt::kWD, RelativePos::kRight));
    // SOUTH 1 0
    o = Open(26187);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kP9, tt::kP9, tt::kP9}, tt::kP9, RelativePos::kLeft));
    o = Open(49770);
    EXPECT_EQ(o.Type(), OpenType::kPon);
    EXPECT_TRUE(check(o, {tt::kGD, tt::kGD, tt::kGD}, tt::kGD, RelativePos::kMid));
    // SOUTH 2 0
    o = Open(36459);
    EXPECT_EQ(o.Type(), OpenType::kPon);
