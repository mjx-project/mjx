...
TEST(state, StateTrans) {
    ...
    auto init_state = State(TruncateAfterFirstDraw(json));
    auto target_state = State(json);
    EXPECT_TRUE(!init_state.Equals(target_state));
